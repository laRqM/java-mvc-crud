...
public class personaAlumno extends db {
    Connection conn = getdb();

    public List<String[]> mostrarTablaPersonaAlumno(String nombreTabla) {
        List<String[]> ListaDatos = new ArrayList<>();

        String query =
                "SELECT persona.id_persona, nombre_uno, nombre_dos, apellido_uno, apellido_dos, matricula, semestre, especialidad,"
                +

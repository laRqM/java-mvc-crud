...
public class EdicionAlumno extends JFrame {
    ...
    public EdicionAlumno(int identificador, String[] rowData) {
        ...
        textField7 = new JTextField(rowData[7]);
        add(new JLabel("Especialidad:"));
        add(textField7);

        textField8 = new JTextField(rowData[8]);
        ...
        btnGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String matricula = textField6.getText();
                String especialidad = textField7.getText();
                String semestre = textField8.getText();

                controladorAlumno controlador = new controladorAlumno();
                controlador.actualizarRegistro(identificador, primerNombre, segundoNombre, apellidoPaterno, apellidoMaterno, fechaNacimiento, matricula, especialidad, semestre);
